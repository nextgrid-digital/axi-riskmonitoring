...
import { contractorPortfolioColumns } from './contractor-portfolio-columns'
...
interface ContractorPortfolioTableProps {
  data: ContractorBondSummary[]
  onRowClick?: (summary: ContractorBondSummary) => void
}

export function ContractorPortfolioTable({ data, onRowClick }: ContractorPortfolioTableProps) {
  ...
  const table = useReactTable({
    data: filteredData,
    columns: contractorPortfolioColumns,
    state: {
      sorting,
      pagination: {
        pageIndex: 0,
          ...
          <Table>
            ...
            <TableBody>
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  <TableCell
                    colSpan={contractorPortfolioColumns.length}
